  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Developed a web application that analyzes environmental data to recommend the most suitable crops for a specific region. Leveraged React, APIs, and geolocation data to deliver actionable insights for farmers and agricultural stakeholders.",
    ...
    },
    {
      title: "DocFind",
      description:
        "Built a healthcare platform that connects doctors and patients, featuring real-time chat powered by Firebase for instant message updates, secure communication, and a seamless consultation experience.",

      tech: ["React", "Firebase", "Tailwind", "Firestore"],
      github: "",
      live: "https://docfind-seven.vercel.app/",
    },
    {
      title: "Pilot Air",
      description:
        "Developed a Java GUI application using Swing that enables users to book flights from Paris to destinations worldwide, featuring flight search, selection, and reservation functionalities (payment integration not included).",

      tech: ["Java", "Java Swing", "PostgreSql"],
      github: "https://github.com/InimfonabasiUdofia/Flight_ticket_system",
      live: "",
    },
    {
      title: "Quiz trivia",
      description:
        "Developed an interactive quiz trivia website that allows users to test their knowledge across multiple categories. The platform have features like dynamically generated questions, real-time score tracking, and a user-friendly interface designed for engagement.",
      tech: ["React", "Firebase", "Chart.js", "Tailwind", "Firestore"],
      github: "",
      live: "https://quiz-one-roan.vercel.app/",
    },
  ];
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <section
          id="home"
          className=" flex items-center justify-center px-4 pt-20"
        >
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="flex justify-center space-x-6">
                <a
                  href="https://github.com/InimfonabasiUdofia"
                  className="text-gray-400 hover:text-purple-400 transition-colors duration-200"
                >
                  <Github size={24} />
                </a>
                <a
                  href="https://www.linkedin.com/in/inimfonabasi-udofia/"
                  className="text-gray-400 hover:text-purple-400 transition-colors duration-200"
                >
                  <Linkedin size={24} />
                </a>
              ...
              <div className="grid   items-center">
                <div className="space-y-6 text-gray-300">
                  <p className="text-lg leading-relaxed font-[poppins]">
                    ...
                    Experienced in TypeScript, Tailwind, Bootstrap, and SSR/SSG
                    for optimized performance, accessibility, and SEO.
                    Highlights include reducing page load times by 40%,
                    developing real-time dashboards with Redux, creating
                    reusable component libraries, and implementing frontend
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                  ...
                  <p className="text-gray-400">inimfonabasi2323@email.com</p>
                </div>
                ...
                <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                  ...
                  <p className="text-gray-400">@InimfonabasiUdofia</p>
                </div>
                ...
                <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
                  ...
                  <p className="text-gray-400">inimfonabasi Udofia</p>
                </div>
              </div>
        ...
        <footer className="py-8 text-center text-gray-400 border-t border-white/10">
          <p>&copy; 2025 Inimfon Udofia ❤️ </p>
        </footer>
      </div>
    </div>
  );
